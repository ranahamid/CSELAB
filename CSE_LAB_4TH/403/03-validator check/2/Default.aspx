...
<body>
    ...
    <div>
        ...
        <br />
        <br />
        <asp:Label ID="Label1" runat="server" CssClass="header_text" 
        ...
        <table style="width:100%;" align="center" cellpadding="1" cellspacing="1" 
            ...
            <tr>
                ...
                <td>
                    <asp:RequiredFieldValidator ID="Full_name_RequiredFieldValidator1" 
                        ...
                        ErrorMessage="Name is Required" SetFocusOnError="True" CssClass="error">Name is Required</asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td class="style1">
                ...
                <td>
                    <asp:RequiredFieldValidator ID="Roll_no_RequiredFieldValidator2" runat="server" 
                        ...
                        ErrorMessage="Roll No is Required" SetFocusOnError="True" CssClass="error">Roll No is Required</asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td class="style1">
                ...
                <td>
                    <asp:RequiredFieldValidator ID="Reg_no_RequiredFieldValidator3" runat="server" 
                        ...
                        ErrorMessage="Reg No is Required" SetFocusOnError="True" CssClass="error">Reg No is Required</asp:RequiredFieldValidator>
                    <asp:RegularExpressionValidator ID="Reg_no_RegularExpressionValidator2" 
                        ...
                        ValidationExpression="\d{6}" CssClass="error">Reg. No. must be 6 digit</asp:RegularExpressionValidator>
                </td>
            </tr>
            <tr>
                <td class="style1">
                ...
                <td class="style2">
                    <asp:TextBox ID="password_textbox" runat="server" BorderColor="#FF66FF" 
                        TextMode="Password" CssClass="div_form"></asp:TextBox>
                </td>
                <td>
                    &nbsp;</td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:CompareValidator ID="Password_CompareValidator1" runat="server" 
                        ...
                        CssClass="error" Display="Dynamic">Password is not match</asp:CompareValidator>
                </td>
            </tr>
            <tr>
                <td class="style1">
            ...
            <tr valign="top">
                ...
                <td class="style2">
                    <asp:Calendar ID="birthday_Calendar1" runat="server" CssClass="table_div_2" 
            ...
            <tr>
                ...
                <td>
                    <asp:RequiredFieldValidator ID="Email_RequiredFieldValidator4" runat="server" 
                        ...
                        ErrorMessage="Email is required" SetFocusOnError="True" CssClass="error">Email is required</asp:RequiredFieldValidator>
                    <asp:RegularExpressionValidator ID="Email_RegularExpressionValidator1" 
                        ...
                        CssClass="error">Email is not in correct format</asp:RegularExpressionValidator>
                </td>
            </tr>
            <tr>
                <td class="style1">
            ...
            <tr>
                ...
                <td>
                    <asp:RequiredFieldValidator ID="Gender_RequiredFieldValidator5" runat="server" 
                        ...
                        ErrorMessage="Gender is Required" SetFocusOnError="True" CssClass="error">Gender is Required</asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td class="style1">
                ...
                <td>
                    <asp:RequiredFieldValidator ID="age_RequiredFieldValidator7" runat="server" 
                        ...
                        ErrorMessage="Age  is Required" SetFocusOnError="True" CssClass="error">Age  is Required</asp:RequiredFieldValidator>
                    <asp:RangeValidator ID="Age_RangeValidator1" runat="server" 
                        ...
                        CssClass="error">Age must be 0 to 150</asp:RangeValidator>
                </td>
            </tr>
            <tr>
                <td class="style1">
                ...
                <td>
                    <asp:RequiredFieldValidator ID="District_RequiredFieldValidator6" 
                        ...
                        CssClass="error">District is Required</asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td class="style1">
                ...
                <td class="style2">
                    <asp:TextBox ID="address_textbox" runat="server" TextMode="MultiLine" 
                        BorderColor="#FF66FF" CssClass="div_form"></asp:TextBox>
                </td>
                <td>
                    &nbsp;</td>
            </tr>
    ...
    <asp:Button ID="Submit_Button1" runat="server" onclick="Submit_Button1_Click" 
        Text="Submit" CssClass="google_button" />
    <br />
    <br />
    <asp:Panel ID="Result_Panel" runat="server" BackColor="#CCCCCC" 
        ...
        <asp:Label ID="result_label" runat="server" CssClass="result_label"></asp:Label>
    </asp:Panel>
    <br />
    <br />
    <br />
