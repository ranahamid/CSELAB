...
<body>
    ...
    <div>
            ...
            <asp:SqlDataSource ID="District_SqlDataSource1" runat="server" 
                ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                SelectCommand="SELECT * FROM [District_Table]"></asp:SqlDataSource>
        ...
        <br />
        <asp:Label ID="result_insert_label" runat="server" Font-Bold="True" 
            ...
            <tr>
                ...
                <td class="style2">
                    <asp:TextBox ID="age_textbox" runat="server" BorderColor="#FF66FF" 
                        CssClass="style5" ValidationGroup="group1"></asp:TextBox>
                </td>
                <td>
            ...
            <tr>
                ...
                <td class="style2">
                    <asp:DropDownList ID="district_DropDownList2" runat="server" 
                        ValidationGroup="group1" AppendDataBoundItems="True" 
                        DataSourceID="District_SqlDataSource1" DataTextField="name" DataValueField="id">
