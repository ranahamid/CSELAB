...
class myclass extends Thread
{
	...
	try
	{
		...
		// p.println("Enter your Name");
		 name=br.readLine();
		 p.println("Welcome "+name+" to Group Chat..To leave type /quit.");
		 for(i=0;i<10;i++)
		 	{
		 	if(t[i]!=null & t[i]!=this)
		 		
		    	{
		 	     ...
		 	     System.out.println("A new user "+name+" entered the Group chat");
		 	    }
		 	}	
	  while(true)
	  		{
	 ...
	 for(i=0;i<10;i++)
	 	...
	 	if(t[i]!=null & t[i]!=this)
	 	{
	 		System.out.println(name+" leave the conversation");
